...
A **Figura 1** a seguir representam a análise de disponibilidade do grupo. Os valores numéricos variam de 1 a 9, indicando o número de membros disponíveis em cada faixa horária.
